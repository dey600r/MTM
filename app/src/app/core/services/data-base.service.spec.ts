...
describe('DataBaseService', () => {
    ...
    beforeEach(async () => {
        const config: any[] = SpyMockConfig.ProvidersServices;
        config.push(SpyMockConfig.ProviderSqlService);
    ...
    it('should be int DB', fakeAsync(() => {
        ...
        const spyDataBase = SpyMockConfig.SpyConfig.sqliteObject.executeSql.and.returnValues(
            Promise.reject(), Promise.resolve({}), Promise.resolve({}), Promise.resolve({}), Promise.resolve({}), Promise.resolve({}),
            Promise.resolve({}), Promise.resolve({}), Promise.resolve({}), Promise.resolve({}));
        const spySqlitePorter = SpyMockConfig.SpyConfig.sqlitePorter.importSqlToDb.and.returnValue(Promise.resolve({ data : { rows: []}}));
        service.initDB();
        tick();
        ...
        expect(service.getDB()).toEqual(SpyMockConfig.SpyConfig.sqliteObject);
    }));
